        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            <div className="img w-16 h-1w-16 rounded-full ">
              <img src="/assets/gdsc-logo.png" alt="me" width="64" height="64" />
            </div>
            <Link to={'/'} className="text flex flex-col justify-start items-start">
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link to="https://www.linkedin.com/company/gdsc-iiitt/"><div className="cursor-pointer linkedin">
            ...
            <Link to="https://www.instagram.com/gdsc_iiitt/"><div className="cursor-pointer insta">
            ...
            <Link to="https://twitter.com/gdsc_iiitt/"><div className="cursor-pointer twitter">
            ...
            {/* <Link to="https://gdscuvpce.medium.com/"><div className="cursor-pointer medium">
