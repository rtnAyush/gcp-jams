        ...
        <footer className='bg-gray-900 text-white grid justify-center p-10 drop-shadow-2xl'>
            ...
            <div className='flex justify-center'>
                ...
                <div className='flex gap-2'>
                    ...
                    <Link to='https://github.com/Ayush211107'><FaGithub className='hover:scale-125' /></Link>
                    <Link to='https://www.linkedin.com/in/rtn-ayush-kumar/'><FaLinkedinIn className='hover:scale-125' /></Link>
                </div>
            </div>
        </footer>
    )
